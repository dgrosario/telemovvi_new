...
type CustomShadows = {
  ...
  lg: string;
  xl: string;
  primary: { sm: string; md: string; lg: string };
  secondary: { sm: string; md: string; lg: string };
  error: { sm: string; md: string; lg: string };
  warning: { sm: string; md: string; lg: string };
  info: { sm: string; md: string; lg: string };
  success: { sm: string; md: string; lg: string };
};

const customShadows = (mode: SystemMode): CustomShadows => {
  return {
