...
import { NodeDeleteButton, nodeContainerStyle, createTargetHandleStyle } from "./node-components";
...
export const EndNode = memo(({ id, data, selected }: NodeProps) => {
  ...
  const getContentPreview = () => {
    if (data.closeConversation) return "Encerra conversa";
    return "Finaliza fluxo";
  };
      ...
      <Box sx={nodeContainerStyle}>
        ...
        >
          ...
          >
            ...
            />
            <StopCircleIcon sx={{ color: "white", fontSize: 44 }} />
          </Box>
        ...
        <NodeDeleteButton nodeId={id} nodeType="end" />
      </Box>
    </Fade>
  );
});
