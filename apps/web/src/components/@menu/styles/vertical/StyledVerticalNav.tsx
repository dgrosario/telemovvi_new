...
const StyledVerticalNav = styled.aside<StyledVerticalNavProps>`
  ...
  inline-size: ${({ width }) => `${width}px !important`};
  min-inline-size: ${({ width }) => `${width}px !important`};
  &.${verticalNavClasses.collapsed} {
    inline-size: ${({ collapsedWidth }) => `${collapsedWidth}px !important`};
    min-inline-size: ${({ collapsedWidth }) => `${collapsedWidth}px !important`};
  }
